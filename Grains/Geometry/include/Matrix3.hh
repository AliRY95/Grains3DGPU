...
class Matrix3
{
  ...
  public:
    ...
    */
    ...
    __host__ __device__ Matrix3( T const* mat );
    ...
    __host__ __device__ Matrix3( T xx, T xy, T xz,
                                 T yx, T yy, T yz,
                                 T zx, T zy, T zz );

    /** @brief Copy constructor
    @param mat the copied matrix */
    __host__ __device__ Matrix3( Matrix3<T> const& mat );
    ...
    __host__ __device__ void setValue( T const* mat );
    ...
    @param zy (3,2) coefficient
    @param zz (3,3) coefficient */
    __host__ __device__ void setValue( T xx, T xy, T xz,
                                       T yx, T yy, T yz,
                                       T zx, T zy, T zz );

    /** @brief Returns a matrix with positive components */
    __host__ __device__ Matrix3<T> absolute() const;

    /** @brief Returns the determinant of the matrix */
    __host__ __device__ T determinant() const;

    /** @brief Returns the inverse of the matrix */
    __host__ __device__ Matrix3<T> inverse() const;

    /** @brief Returns the transposed matrix */
    __host__ __device__ Matrix3<T> transpose() const;
    //@}
    ...
    __host__ __device__ Matrix3<T>& operator += ( Matrix3<T> const& mat );
    ...
    __host__ __device__ Matrix3<T>& operator *= ( T d );
    ...
    @param i row number */
    __host__ __device__ Vector3<T>& operator [] ( unsigned int i ) const;
