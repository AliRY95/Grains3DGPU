...
class AABB
{
  ...
  public:
    ...
    @param y 2nd component
    @param z 3rd component */
    __host__ __device__ void setExtent( float x, float y, float z );

    /** @brief Sets the extent values according to the convex which we want to 
    fit the AABB around.
    @param convex convex object */
    __host__ __device__ void setExtent( Convex const& convex );
    ...
    @param y 2nd component
    @param z 3rd component */
    __host__ __device__ Vec3f const getExtent() const;
    //@}
};
