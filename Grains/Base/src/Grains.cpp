...
void Grains<T>::Construction( DOMElement* rootElement )
{
    ...
    GrainsParameters::m_dimension.setValue( 
    ...
    if ( domain_origin )
        GrainsParameters::m_origin.setValue( 
        ...
        GrainsParameters::m_origin.setValue( T( 0 ), T( 0 ), T( 0 ) );

    GrainsParameters::m_isPeriodic = false;
