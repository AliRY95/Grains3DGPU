...
void GrainsTestDev<T>::simulate()
{
    ...
    Transform3<T>* d_tr1;
    Transform3<T>* d_tr2;
    cudaErrCheck(cudaMalloc((void**)&d_tr1, N * sizeof(Transform3<T>)));
    cudaErrCheck(cudaMalloc((void**)&d_tr2, N * sizeof(Transform3<T>)));
    ...
    std::cout << "CPU: " << h_time.count() << ", GPU: " << d_time.count()
