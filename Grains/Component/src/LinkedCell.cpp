...
template <typename T>
__HOSTDEVICE__
void LinkedCell<T>::checkBound( int3 const& id ) const
{
...
template <typename T>
__HOSTDEVICE__
int3 LinkedCell<T>::computeCellId( Vector3<T> const& p ) const
{
    int3 cellId;
...
template <typename T>
__HOSTDEVICE__
int LinkedCell<T>::computeLinearCellHash( Vector3<T> const& p ) const
{
...
template <typename T>
__HOSTDEVICE__
int LinkedCell<T>::computeLinearCellHash( int3 const& cellId ) const
{
...
template <typename T>
void LinkedCell<T>::computeLinearLinkedCellHashCPU( std::vector<Transform3<T>> const& tr,
