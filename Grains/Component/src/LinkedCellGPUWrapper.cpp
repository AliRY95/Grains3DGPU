...
template <typename T>
__GLOBAL__ void createLinkedCellOnDeviceKernel(T               minX,
                                               T               minY,
                                               T               minZ,
                                               T               maxX,
                                               T               maxY,
                                      ...
                                      LinkedCell<T>** LC)
{
    ...
    createLinkedCellOnDeviceKernel<<<1, 1>>>(min[X],
                                             min[Y],
                                             min[Z],
                                             max[X],
                                             max[Y],
...
#define X(T)                                                             \
    template __HOST__ int createLinkedCellOnDevice(Vector3<T>      min,  \
                                                   Vector3<T>      max,  \
                                                   T               size, \
                                                   LinkedCell<T>** LC);  \
                                                                         \
